...
if(isset($_GET['id'])) {
    ...
    $data = executeResult($sql, true);//true là lấy 1 bảng ghi 
...
<div class="col-md-12" style="margin-bottom: 20px;">
    <h3>QUẢN LÝ DANH MỤC SẢN PHẨM</h3></div>
...
<!-- Cho phép xóa danh mục sản phẩm -->
<script type="text/javascript">
    function deleteCategory(id) {
        ...
        $.post('form_api.php', {
            ...
            //Thông báo cho người dùng biết danh mục này không xóa được
            if(data != null && data != '') {
                alert(data);
                return;
            }
